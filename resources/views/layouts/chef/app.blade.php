    ...
    <div class="container">
      ...
      <div class=" collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto ">
          <li class="nav-item">
            <a  class="nav-link mx-2 {{(Route::Current()->getName() == 'chefs.home') ? 'active':''}}" href="{{route('chefs.home')}}">Fluxo de Atendimento</a>
          </li>
          <li class="nav-item">
            @livewire('chef.delivery-count')
          </li>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item text-dark" style="color: #000 !important" href="{{route('chefs.account')}}"><i class="fas fa-user mr-2"></i> Conta</a></li>
      ...
      <div class="row mt-5">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">PAINEL DE CHEFE DE COZINHA</h2>
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          @if (Route::Current()->getName() == 'chefs.home')
                          <li class="breadcrumb-item"><a href="{{route('chefs.home')}}" class="breadcrumb-link">Fluxo de Atendimento</a></li>
