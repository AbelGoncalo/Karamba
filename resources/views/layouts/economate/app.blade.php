                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="{{route('economate.panel.myaccount')}}"><i class="fas fa-user mr-2"></i>Conta</a>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link {{(Route::Current()->getName() == 'economate.panel.home') ? 'active':''}}" href="{{route('economate.panel.home')}}" >
                            <i class="fa fa-chart-pie"></i>
                            Dashboard</a>
                    </li>
                    
                    <li class="nav-item ">
                        <a class="nav-link {{(Route::Current()->getName() == 'economate.panel.compartment') ? 'active':''}} " href="{{route('economate.panel.compartment')}}" >
                            <i class="fa fa-home"></i>
                            Compartimentos</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link {{(Route::Current()->getName() == 'economate.panel.category') ? 'active':''}} " href="{{route('economate.panel.category')}}" >
                            <i class="fa fa-box"></i>
                            Categorias</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link {{(Route::Current()->getName() == 'economate.panel.product') ? 'active':''}}" href="{{route('economate.panel.product')}}" >
                            <i class="fa fa-tag"></i>
                            Produtos</a>
                    </li>
                    {{-- <li class="nav-item ">
                        <a class="nav-link {{(Route::Current()->getName() == 'economate.panel.provider') ? 'active':''}}" href="{{route('economate.panel.provider')}}" >
                            <i class="fa fa-users"></i>
                            Fornecedores</a>
                    </li>--}}
                    {{-- <li class="nav-item ">
                        <a class="nav-link {{(Route::Current()->getName() == 'economate.panel.order') ? 'active':''}}" href="{{route('economate.panel.order')}}" >
                            <i class="fa fa-arrow-right-arrow-left"></i>
                            Transferir</a>
                    </li>  --}}
                    <li class="nav-item ">
                        <a class="nav-link {{(Route::Current()->getName() == 'economate.panel.stockenter') ? 'active':''}}" href="{{route('economate.panel.stockenter')}}" >
                            <i class="fa fa-plus"></i>
                            Entrada de Estoque</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link {{(Route::Current()->getName() == 'economate.panel.stockout') ? 'active':''}}" href="{{route('economate.panel.stockout')}}" >
...
<x-livewire-alert::scripts />
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js"></script>
    ...
    @stack('chart')
    @stack('select2-economate')
    @stack('select2-to')
    @stack('select2-from')
    @stack('select2-verify')
