...
<div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#category-economate">Adicionar</button>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @if (isset($categories) and $categories->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:20%">
                                            <button wire:click='editCategory({{$item->id}})' data-toggle="modal" data-target="#category-economate" class="btn btn-sm btn-primary mt-1"><i class="fa fa-edit"></i></button>
    ...
    @include('livewire.economate.modals.category-economate')
</div>
