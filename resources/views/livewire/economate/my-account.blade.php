                ...
                <div class="card-body">
                    <form wire:submit="updateAccount"  class="container">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 d-flex justify-content-end flex-wrap text-end">
                    ...
                    <form wire:submit='updatePassword' method="post" class="container">
                        <div class="row">
                            ...
                            <div class="form-group d-flex col-md-12 text-end justify-content-end flex-wrap">
                                <button type="submit" class="btn btn-md" style=" background-color: #222831e5;color:#fff;">
                                    ACTUALIZAR
                                </button>
                            </div>
