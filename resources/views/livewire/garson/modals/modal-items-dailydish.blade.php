                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                             ...
                             <select wire:ignore wire:model="type_menu" class="form-control" name="type_menu" id="type_menu">
                            ...
                            <div class="form-group">
                             ...
                             <select wire:ignore wire:model="client_entrance" class="form-control" name="client_entrance" id="client_entrance">
                              <option value="">--Selecionar--</option>
                              @foreach ($itemsDailydishes as $item)
                            ...
                            <div class="form-group">
                             ...
                             <select wire:ignore wire:model="client_drink" class="form-control" name="client_drink" id="client_drink">
                              <option value="">--Selecionar--</option>
                              @foreach ($itemsDailydishes as $item)
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select wire:ignore wire:model="client_maindish" class="form-control" name="client_maindish" id="client_maindish">
                                <option value="">--Selecionar--</option>
                                @foreach ($itemsDailydishes as $item)
                            ...
                            <div class="form-group">
                              ...
                              <select wire:ignore wire:model="client_dessert" class="form-control" name="client_dessert" id="client_dessert">
                                <option value="">--Selecionar--</option>
                                @foreach ($itemsDailydishes as $item)
                            ...
                            <div class="form-group">
                             ...
                             <select wire:ignore wire:model='client_coffe' class="form-control" name="client_coffe" id="client_coffe">
                              <option value="">--Selecionar--</option>
                              @foreach ($itemsDailydishes as $item)
