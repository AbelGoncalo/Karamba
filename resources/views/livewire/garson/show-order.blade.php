    ...
    <div class="row  mt-2">
        <div class="col-md-4">
            <div class="input-group" wire:ignore>
              <select wire:model.live='tableNumber'  name="tableNumber" id="tableNumber" class="form-select text-uppercase selectShowOrders">
                <option value="" select>
                  --Selecionar Mesa--
                </option>
...
<script>
     $(document).ready(function() {
        $('.selectShowOrders').select2({
          theme: "bootstrap-5",
          width:'100%',

        });
      
        $('.selectShowOrders').change(function (e) { 
          e.preventDefault();
          @this.set('tableNumber', $('.selectShowOrders').val());
        });
        });
</script>
@endpush
