<div id="book">
  <div class="container-fluid py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
    <div class="row g-0">
        <div class="col-md-6">
            <div class="video">
                <button type="button" class="btn-play" data-bs-toggle="modal" data-src="https://www.youtube.com/watch?v=Dxjpn39PXXY&list=PLTNWXGeWrMqj6l3APan4Y9YGuorhBU9sW&index=18" data-bs-target="#videoModal">
                    <span></span>
                </button>
            </div>
        </div>
        <div class="col-md-6 rese d-flex align-items-center">
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                <h5 class="section-title ff-secondary text-start text-light fw-normal" style="color: #cf597a !important">Reserva Mesa</h5>
                <h1 class="text-white mb-4" style="color: #cf597a !important">Marque já a sua Reserva</h1>
