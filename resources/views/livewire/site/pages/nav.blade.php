<nav style="{{(Route::Current()->getName() == 'site.companies' || Route::Current()->getName() == 'site.company' || Route::Current()->getName() == 'site.about' || Route::Current()->getName() == 'site.cart') ? 'background-color: var(--primary) !important; margin-bottom:5rem !important':''}}" class="navbar navbar-expand-lg navbar-dark bgnavbar  px-4 px-lg-5 py-3 py-lg-0"  style="background-color: red">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0 pe-4">
            ...
            <a href="{{route('site.companies')}}" style='{{(Route::Current()->getName() == 'site.companies') ? 'color:#0f172b !important':''}}' class="nav-item nav-link">Restaurantes</a>
            <a href="" style='' class="nav-item nav-link">24/7</a>
     ...
     <div class="container my-5 py-5">
         <div class="row g-5 mt-3">
             <div class="col-lg-12  text-lg-center">
                 <h1 class="display-1 text-white slideInLeft" style="font-size: 12vw;">Kytutes</h1>
                 <p class="text-white animated slideInLeft mb-4 pb-2">Localize os restaurentes mais proximo de si</p>
                 <p class="text-white animated slideInLeft mb-4 pb-2"><i class="fa fa-map-marker-alt me-3"></i>Ponte Molhada (Talatona)</p>
                 <div class="">
                    <a href="{{route('site.companies')}}" class="btn  py-sm-3 px-sm-5 me-3 animated slideInLeft text-light" style="background-color: var(--primary);">Ver Restaurantes</a>
                    <a href="" class="btn  py-sm-3 px-sm-5 me-3 animated slideInLeft text-light" style="background-color: var(--primary);">24/7</a>
                 </div>
             </div>
         </div>
     </div>
